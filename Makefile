...
SRCS = src/Main.c src/moduloD/manual.c src/moduloC/ModuloC.c src/moduloC/c_array.c src/moduloC/d_matrix.c src/moduloD/d_array.c src/moduloD/moduloD.c src/moduloD/tree.c src/moduloD/auxiliar.c src/moduloF/moduloF.c src/utils/fsize.c #src/moduloT/ModuloT.c src/moduloT/ModuloT.h src/utils/Lista.c src/utils/Lista.h
